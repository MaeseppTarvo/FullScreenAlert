...
public class AlertView: UIViewController {
    ...
    public init(title: String? = nil, message: String? = nil, image: UIImage, config: Config? = nil){
        super.init(nibName: "AlertView", bundle: Bundle(for: AlertView.self))
    ...
    public init(type: AlertType, title: String? = nil, message: String? = nil, config: Config? = nil) {
        ...
        switch type {
        case .Success:
            self.alertImage = UIImage(named: "Success", in: Bundle(for: AlertView.self) , compatibleWith: nil)
        case .Warning:
            self.alertImage = UIImage(named: "Warning", in: Bundle(for: AlertView.self), compatibleWith: nil)
        case .Error:
            self.alertImage = UIImage(named: "Error", in: Bundle(for: AlertView.self), compatibleWith: nil)
        }
